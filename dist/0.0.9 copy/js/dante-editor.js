...
(function() {
  ...
  Dante.Editor.Tooltip = (function(_super) {
    ...
    Tooltip.prototype.insertWidgets = function(){
      utils.log("TRYING TO MAKE THINGS WORK");
      utils.log(this.current_editor.widgets);

      var name = this.current_editor.widgets + ".js";
      var path = "./widgets/" + name;
